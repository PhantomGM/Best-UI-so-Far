...
_E.g., A god left behind a machine no one dares touch; All the birds are spies_
...
**Instructions:** Reply with the number of the option followed by your information to guide the region's design.

1.  Region Name:
2.  Dominant Feature (e.g., A giant crystal, a perpetual storm):
3.  Climate:
4.  Culture (e.g., Nomadic hunters, reclusive scholars):
5.  Major Conflict:
6.  Main Exports (e.g., Rare ores, magical beasts):
7.  Historical Tidbit:
8.  Primary Threat:
9.  Key Landmark:
10. Magic Level (e.g., High, Low, Wild):
...
- **Magic Item:** Modify the base Item DNA by adjusting the core M/A/C scales or other attributes based on the user's focus (7) before decoding. Use all other text fields as narrative context.
